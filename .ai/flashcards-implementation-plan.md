...
-CreateFlashcardDto - BatchCreateFlashcardsDto - PaginationQueryDto;
```
...
-CreateFlashcardSchema - BatchCreateFlashcardsSchema - FlashcardQuerySchema - UpdateFlashcardSchema;
```
